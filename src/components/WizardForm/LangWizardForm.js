...
const step3TooltipFiles = { id: 'wizard.step3.tooltip.files', defaultMessage: 'Helpful documents to include can be: Land tenure claims/deeds, forest maps or ground surveys, project goals, or any other information that helps describe your project.' };
