...
const daysText = { id: 'projectPage.info.days', defaultMessage: 'days' };
const remainingDurationText = { id: 'projectPage.info.remainingDuration', defaultMessage: 'Remaining duration' };
const uploadsText = { id: 'projectPage.info.uploads', defaultMessage: 'Remaining uploads' };
export { sizeText, sqkmText, treesText, totalDurationText, monthsText, daysText, remainingDurationText, uploadsText };
